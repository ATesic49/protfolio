...
const HeroSection: React.FC = () => {
    ...
    return (
        <div id='Pocetna' className=' pt-20 md:pt-0 overflow-hidden items-start justify-start md:items-center md:justify-center relative'>
            <Image alt='' src={Hero} className=' hidden md:block absolute right-0 h-full w-auto brightness-75 rounded-lg' priority></Image>
            <div className='bg-white z-10 flex-col w-fit flex gap-4 relative p-10 md:min-h-[100vh] md:pl-10  md:justify-center md:items-center  after:absolute after:hidden md:after:block after:top-[-25%] after:left-[75%] after:h-[150%] after:bg-white after:w-[20vw] after:rotate-12 after:z-[-1] md:px-0 px-[2em]'>
                <h1 className='text-4xl md:text-6xl text-transparent bg-clip-text font-extrabold leading-[130%] bg-gradient-to-tr from-cyan-400 to-pink-400  max-w-[12em] md:max-w-[9em] w-fit'>
                    Savršen sajt za vaš biznis
                </h1>
                <p className='max-w-[25em]  font-light text-gray-400  text-sm md:text-lg leading-relaxed w-fit ' >Proširite svoje ideje i uticaj na online područja websajtom koji će vas idealno predstaviti.</p>
                <motion.div
