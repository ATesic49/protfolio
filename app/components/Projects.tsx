...
function Projects() {
    return (
        <div className='flex flex-col gap-20 justify-center items-center py-24'>
            ...
            <div className='group hover:bg-gray-200 duration-200 rounded-xl border border-netral-200 overflow-hidden gap-10 md:grid md:grid-cols-3 bg-gray-100  w-11/12 md:w-8/12'>
                <div
