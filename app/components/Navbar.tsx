...
function Navbar() {
  return (
    <div className="to bg-50 fixed z-[999] w-full border border-b-gray-300 bg-opacity-20 bg-gradient-to-tr from-pink-50 backdrop-blur-lg">
      <nav className="px- flex items-center justify-start gap-6 px-2 py-2 md:gap-16 md:px-8 md:py-4">
        <svg
        ...
        <Link
          ...
          offset={0}
          duration={500}
          className="cursor-pointer text-sm text-gray-600 duration-200 hover:text-black md:text-lg"
        >
          Home
        </Link>
